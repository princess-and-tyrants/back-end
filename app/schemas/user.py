...
class User(Base):
    ...
    mbti_tf_score = Column(Integer, nullable=False, comment="MBTI 3번째 (F,T) [0(100)~100(0)]")
    mbti_pj_score = Column(Integer, nullable=False, comment="MBTI 4번째 (P,J) [0(100)~100(0)]")
